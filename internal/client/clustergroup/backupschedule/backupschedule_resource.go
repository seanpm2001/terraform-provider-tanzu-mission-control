...
*/
func (a *Client) VmwareTanzuManageV1alpha1ClustergroupBackupScheduleResourceServiceDelete(
	fullName *backupscheduleclustergroupmodel.VmwareTanzuManageV1alpha1ClustergroupDataprotectionScheduleFullName) error {
